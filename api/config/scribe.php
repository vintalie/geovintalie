...
return [
    ...
    'auth' => [
        'enabled' => true,
        'default' => true,          // Importante: mantém como padrão
        'in' => 'header',           // Onde o token vai
        'name' => 'Authorization',  // Nome do cabeçalho
        'description' => 'Autenticação via JWT Bearer Token.',
        
        // 🔥 A mágica acontece aqui: chamamos nossa estratégia
        'strategies' => [
            \App\Scribe\JwtAuthenticationStrategy::class,
        ],
